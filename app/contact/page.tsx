...
import { contactService, contactUtils, type ContactFormData } from "@/lib/services/contactService";
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const sanitizedData = contactUtils.sanitizeFormData(formState);
    const validation = contactUtils.validateContactForm(sanitizedData);
    ...
    try {
      const result = await contactService.submitContact(sanitizedData);
      ...
      setErrors(["An unexpected error occurred while sending your message."]);
    } finally {
